            ...
            {markers.map((marker) => {
              ...
              return (
                ...
                >
                  {marker % 10 == 0 && (
                    <>
                      <div className="absolute bottom-0 w-[1px] h-2 border border-black bg-neutral-500" />
                  ...
                  {marker % 5 == 0 && marker % 10 != 0 && (
                    <div className="absolute bottom-0 w-[1px] h-1.5 border border-black bg-neutral-500" />
                  )}
                  {marker % 5 != 0 && (
