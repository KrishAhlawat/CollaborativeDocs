    ...
    <div className="flex items-center gap-x-0.5">
      ...
      {isEditing ? (
        <input
          ...
          className="h-7 w-8 text-sm text-center border border-neutral-400 rounded-sm bg-transparent focus:outline-none focus:ring-0"
        />
      ) : (
        <button
          onClick={() => {
          ...
          className="h-7 w-8 text-sm text-center border border-neutral-400 rounded-sm bg-transparent cursor-text"
        >
          {currentFontSize}
        </button>
      )}
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          ...
          <Input
            ...
            onKeyDown={(e) => {
              if (e.key === "Enter") {
                handleInputURLSubmit();
              }
            }}
          />
          <DialogFooter>
            <Button onClick={handleInputURLSubmit}>Insert</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </>
...
export const Toolbar = () => {
  ...
  const sections: {
    ...
    // Comment, TaskList, Remove Formatting
    [
      {
        label: "Comment",
